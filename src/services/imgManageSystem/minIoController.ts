...
export async function batchDownloadUsingPost(
  ...
  params: API.batchDownloadUsingPOSTParams,
...
/** downloadImage POST /api/images/download */
export async function downloadImageUsingPost(
  // 叠加生成的Param类型 (非body参数swagger默认没有生成对象)
  params: API.downloadImageUsingPOSTParams,
  options?: { [key: string]: any },
) {
